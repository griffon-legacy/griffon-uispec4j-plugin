 ...
 */
@Command(scope = "uispec4j",
        name = "create-uispec-test",
        description = "Creates a new Griffon UISpec4j test")
public class CreateUispecTestCommand extends AbstractGriffonCommand {
    @Argument(index = 0,
            name = "name",
